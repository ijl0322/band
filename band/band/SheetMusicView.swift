...
class SheetMusicView: UIImageView {
    ...
    func setUp() {
        ...
        drumButton.setImage(UIImage(named: "sheetMusicButton_d"), for: .normal)
    ...
    func buttonTapped(_ button: UIButton) {
        ...
        case 2:
            ...
            self.image = UIImage(named: "violinSheetMusic")
            break
        case 3:
            drumButton.backgroundColor = darkGrey
            self.image = UIImage(named: "drumSheetMusic")
            break
        case 4:
            saxphoneButton.backgroundColor = darkGrey
            self.image = UIImage(named: "saxphoneSheetMusic")
            break
        case 5:
            tromboneButton.backgroundColor = darkGrey
            self.image = UIImage(named: "tromboneSheetMusic")
            break
        default:
            break
        }
